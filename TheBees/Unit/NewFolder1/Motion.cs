...
namespace TheBees.UnitData
{
    ...
    public class Motion : ActionNode
    {
        ...
        {
            return new Motion(address, type);
        }
        ...
        {
            get { return (GetValue("tweakMotion")&0xFF)/2; }
            set { uint tweakValue = GetValue("tweakMotion"); SetValue("tweakMotion", (value & (tweakValue & 0xFF00))*2); }
        }
